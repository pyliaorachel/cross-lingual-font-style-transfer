...
class Dataset(data.Dataset):
    def __init__(self, dataset, imsize, dtype=torch.FloatTensor):
    ...
    def __getitem__(self, index):
        ...
        X = image_loader(image_name, self.imsize, first_dim=False).type(self.dtype)
        return X, image_name

class PairedDataset(data.Dataset):
    def __init__(self, dataset, paired_dataset, imsize, dtype=torch.FloatTensor):
        self.dataset = dataset
    ...
    def __getitem__(self, index):
        ...
        Y = image_loader(paired_image_name, self.imsize, first_dim=False).type(self.dtype)
